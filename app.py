...
label = Label(root, image=image, bg='dark green')
label.place(x=180, y=20)

label1 = Label(root,
    text="Hey User! Welcome to enomination Counter Application.",
    bg='dark green')
...
bg='light green')
    ...
    btn = Button(top, text='Calculate', command=calculator, bg='light green',
fg='green')
