...
print(f"Type a sentance and I will analyze your sentances with Text blob and show you the sentiment. ")
...
while True:
    ...
    if not user_input:
        print(f"{Fore.RED}Please Enter Some Text Or Vaild Command.{Style.RESET_ALL}")
        continue
